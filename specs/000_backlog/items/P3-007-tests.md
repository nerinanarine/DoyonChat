...
5. カバレッジ 80% 以上
6. OpenCode Goの全モデル実API疎通は[P2-011](P2-011-opencode-go-models.md)で実施する（2026-08-23時点の23モデル版は23/23成功、2026-08-31の26モデル版も26/26成功）。カタログ変更時はP2-011の専用live testを再実行する
...
| 2026-08-23 | 🔴 未対応 | P2-011で実施済みとして参照（2026-08-23時点で23モデル） |
| 2026-08-31 | 🔴 未対応 | P2-011のカタログ更新（26モデル）後、26/26のlive test成功を反映 |
